...
#_________________________________________________________________________________________________
#
# This script generates speech and image positive pairs from latents extracted from a classifier 
# model.
#
    ...
    for i in tqdm(range(len(latents)), desc="Calculating distances", ncols=COL_LENGTH):
        ...
        while len(pairs) < args.num_pairs and count < len(indices):
            ...
            if current_key != pair_key:
                ...
                elif speech_not_image_pairs is False and distances[indices[count]] > lower_limit and distances[indices[count]] < upper_limit: pairs.append(pair_key)
            count += 1
