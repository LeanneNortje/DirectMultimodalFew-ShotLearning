...
#_________________________________________________________________________________________________
#
# This script generates speech or image latents from a classifier model.
#
...
def speech_rnn_latent_values(lib, feats_fn, latent_dict, ):
...
def main():
    ...
    if os.path.isfile(key_pair_file) is False:
        ...
        if speech_not_image_pairs:
            ...
            latents = speech_rnn_latent_values(speech_lib, args.feats_fn, latent_dict)

        else: 
            print(f'Restoring model from: {model_path}')
            image_lib = model_setup_library.restore_lib(model_path)   

            latents = image_cnn_latent_values(image_lib, args.feats_fn, latent_dict)
