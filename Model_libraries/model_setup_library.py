...
IMAGE_PAIR_TYPES = ["classifier"]
SPEECH_PAIR_TYPES = ["classifier"]
...
def arguments_for_model_setup():
    ...
    parser.add_argument("--pair_type", type=str, choices=["classifier", "default"], default=str(default_model_lib["pair_type"]))
